...
export const AUDIT_ACTIONS = Object.freeze({
  ...
  EMPLOYER_SUBMITTED_FOR_REVIEW: "EMPLOYER_SUBMITTED_FOR_REVIEW",
  APPLICATION_EMPLOYER_RESPONSE: "APPLICATION_EMPLOYER_RESPONSE",
  DOCUMENT_REJECTED_INVALID_FILE: "DOCUMENT_REJECTED_INVALID_FILE",
});
...
// A student may have only ONE application in these states at a time
...
// What a student may do, and from which statuses
export const STUDENT_CAN_SUBMIT_FROM = Object.freeze([
  APPLICATION_STATUS.DRAFT,
  APPLICATION_STATUS.NEEDS_REVISION,
]);

export const STUDENT_CAN_WITHDRAW_FROM = Object.freeze([
  APPLICATION_STATUS.DRAFT,
  APPLICATION_STATUS.SUBMITTED,
  APPLICATION_STATUS.UNDER_REVIEW,
  APPLICATION_STATUS.NEEDS_REVISION,
