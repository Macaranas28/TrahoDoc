...
export const AUDIT_ACTIONS = Object.freeze({
  ...
  EMPLOYER_ACCREDITATION_DECIDED: "EMPLOYER_ACCREDITATION_DECIDED",
  RISK_FLAG_REVIEWED: "RISK_FLAG_REVIEWED",
  MFA_SETUP_STARTED: "MFA_SETUP_STARTED",
  MFA_ENABLED_ACTION: "MFA_ENABLED_ACTION", // avoids clashing with the boolean field name
...
export const MFA = Object.freeze({
  ISSUER: "TrahoDoc",
  BACKUP_CODE_COUNT: 8,
  PENDING_TOKEN_TTL_SECONDS: 5 * 60, // 5 minutes to enter the code after password login
});